            ...
            <div className="flex items-center justify-between px-2 py-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-mono uppercase text-gray-400">Patient</p>
                </div>
              </div>
      ...
      <nav className={cn(
        ...
        <div className="h-13 border-b border-gray-200 flex items-center px-5 shrink-0">
          <Link href="/user/dashboard" className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-sm font-bold text-gray-900 tracking-tight">UniMeds</span>
              <p className="text-[10px] font-mono uppercase text-gray-400 tracking-wider">Patient Portal</p>
            </div>
          </Link>
        </div>
        ...
        <div className="border-t border-gray-200 p-4 space-y-3 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">{userName || 'User'}</p>
              <p className="text-[10px] font-mono uppercase text-gray-400 tracking-wider">Patient</p>
            </div>
            <NotificationBell apiPrefix="/user" />
          </div>
          <LogoutButton
