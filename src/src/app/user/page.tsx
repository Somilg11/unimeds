      ...
      rightPanel={
        <>
          ...
          <p className="text-white/60 text-[15px] leading-relaxed max-w-sm text-center">
            Access your health records, book appointments, and connect with your doctors — all in one place.
          </p>
        </>
      }
    >
      <div className="w-full max-w-[400px] text-left">
        ...
        <div className="lg:hidden mb-8 -mt-2">
          ...
          <h1 className="text-[24px] font-bold tracking-tight text-gray-900 mb-1">Patient Portal</h1>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className="text-[12px] text-gray-600 font-medium">HIPAA Protected &middot; Secure Login</span>
          </div>
