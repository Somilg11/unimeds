  ...
  return (
    <PortalLandingLayout title="Patient Portal">
      <div className="w-full max-w-[400px] bg-white rounded-3xl shadow-apple border border-gray-100 p-8 sm:p-10 animate-subtle text-center">
        ...
        <h1 className="text-[22px] font-bold tracking-tight text-gray-900 mb-2">Patient Portal</h1>
        <p className="text-[14px] text-gray-500 mb-8 leading-relaxed px-2">
          Access your health records and book appointments seamlessly.
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="flex items-center justify-center gap-1.5 mb-3">
            ...
            <span className="text-[11px] text-gray-500 font-medium">HIPAA Protected &middot; Secure Login</span>
          </div>
