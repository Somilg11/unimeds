          ...
          <div className="border-t border-gray-100 p-4 space-y-3 bg-gray-50/50">
            <div className="flex items-center justify-between px-2 py-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[14px] font-semibold text-gray-900 truncate">{userName || 'Clinic Admin'}</p>
                  <p className="text-[12px] text-gray-500">Clinic Admin</p>
                </div>
              </div>
        ...
        <div className="h-16 flex items-center px-6 shrink-0 mb-4">
          <Link href="/clinic/dashboard" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 font-medium">Clinic Admin Portal</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 space-y-3 shrink-0">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[14px] font-semibold text-gray-900 truncate">{userName || 'Clinic Admin'}</p>
              <p className="text-[12px] text-gray-500 font-medium">Clinic Admin</p>
            </div>
            <NotificationBell apiPrefix="/clinic-admin" />
          </div>
          <LogoutButton
